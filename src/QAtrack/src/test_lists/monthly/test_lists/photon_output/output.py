from test_lists.monthly.test_lists.photon_output.dmlc import (
    MONTHLY_DMLC,
    MONTHLY_INVALID_DMLC,
)
from test_lists.monthly.test_lists.photon_output.edw import MONTHLY_EDW
from test_lists.general.general_photon import (
    MONTHLY_CTP_PHOTON,
    MONTHLY_ND_PHOTON,
)
from test_lists.monthly.test_lists.photon_output.kv_cbct import QUARTERLY_KV_CBCT
from test_lists.monthly.test_lists.photon_output.oc import MONTHLY_OC_DOSE
from test_lists.monthly.test_lists.photon_output.tmr import MONTHLY_TMR
from test_lists.monthly.test_lists.photon_output.vmat import MONTHLY_VMAT
