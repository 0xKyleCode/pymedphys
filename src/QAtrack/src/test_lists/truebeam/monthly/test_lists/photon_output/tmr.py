...
MONTHLY_TMR = {
    ...
    "slug": "monthly-tmr",
    "description": """<font color="#0070c0">Plan<b>5Photon_Dmax.dcm</b></font>
    <br><b>Electrometer:</b> med range, nC, -300V
    <br><b>SETUP:</b> As per above except depth nominal dmax, <b><font color="red">d=2.5 cm</font> for all</b>
