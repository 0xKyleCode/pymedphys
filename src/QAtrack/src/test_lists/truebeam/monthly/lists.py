...
from test_lists.truebeam.monthly.test_lists.cbct.cbct import MONTHLY_CBCT
from test_lists.truebeam.monthly.test_lists.electron_output.output import (
    MONTHLY_ELECTRON_OUTPUTS,
)
from test_lists.truebeam.monthly.test_lists.motion.motion import MONTHLY_MOTION
from test_lists.truebeam.monthly.test_lists.mvd.mvd import MONTHLY_MVD
from test_lists.truebeam.monthly.test_lists.photon_output.output import (
...
from test_lists.truebeam.monthly.test_lists.registration.registration import (
