import os
import re
from constants.linacs import BCCALinac
from constants.machine_template import BCCABaseQA
from qa_tpk.testpack import BCCATestpack
import xlwings as xw

from test_lists.truebeam.test_list_definitions import ALL_TEST_LISTS
...
class BCCAMonthlyTruebeamQA(BCCABaseQA):
    ...
    def make_testpack(self, result: str):
        ...
        """
        tpk = BCCATestpack().make_test_tpk(self.filename, ALL_TEST_LISTS)
