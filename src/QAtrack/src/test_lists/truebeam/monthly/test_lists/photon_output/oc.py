...
MONTHLY_OC_DOSE = {
    ...
    "slug": "monthly-oc",
    "description": r"""<font color="#0070c0">Plan: <b>1Photon_OP.dcm</b></font>
    <br><b>Electrometer:</b> med range, nC, -300V
    <br><b>SETUP:</b>  Gantry 0°, Collimator 0°, Couch 0°, Farmer chamber in solid water with axis aligned to mechanical crosshair and perpendicular to couch LNG, SAD100 in solid water, Depth 10 cm, Backscatter 5 cm solid water slab, Field Size 10x10 cm
