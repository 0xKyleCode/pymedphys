...
MONTHLY_DMLC = {
    ...
    "slug": "6x-dmlc-factor",
    "description": """<font color="#0070c0">Plan if not Oak: <b>2dMLC_OP.dcm</b>
    <br>Plan if Oak: <b>2dMLC_HD_OP.dcm</b></font>
    <br><b>Electrometer:</b> med range, nC, -300V
    <br><b>SETUP:</b> as above
      <br><b>ACQUISITION:</b> as above
      <br><b>NOTE:</b> For 5 mm interrupt, half way through leaf sequence delivery press Beam OFF button on console, then complete delivery
    """,
    "tests": [
...
MONTHLY_INVALID_DMLC = {
    ...
    "description": """<font color="#0070c0">Plan if not Oak: <b>4dMLC_Error.dcm</b>
    <br>Plan if Oak: <b>4dMLC_HDErr.dcm</b></font>
    <br><b>Electrometer:</b> med range, nC, -300V
    <br><b>SETUP:</b>  as above
      <br><b>ACQUISITION:</b> Attempt to deliver leaf sequence, software interlock should occur
    """,
